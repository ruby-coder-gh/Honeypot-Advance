...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col(dcc.Graph(figure=px.bar(top_cmds, x='Command', y='count')) if not top_cmds.empty else html.Div("No command data available.", style={'width': '33%', 'display': 'inline-block'})),
